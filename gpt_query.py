...
# 交互式获取API密钥
API_SECRET_KEY = getpass.getpass("Please enter your OpenAI API key: ")
...
prompt1 = ChatPromptTemplate.from_template(
    "Let's think step by step. Please give me a detailed description "
    "of the following categories in one sentence (including shape, color, "
    "characteristics, habits, functions, etc.): {cls_words}"
)
prompt2 = ChatPromptTemplate.from_template(
    "Given these visual descriptions: {prompt1}. \n\n Please summarize five general and independent attributes in one noun, \n\n {format_instructions}",
